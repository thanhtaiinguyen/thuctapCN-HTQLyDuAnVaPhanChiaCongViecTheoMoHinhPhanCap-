...
namespace thuctapCN.Migrations
{
    ...
    [Migration("20251229152310_AddNotificationsAndSchedules")]
    partial class AddNotificationsAndSchedules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("thuctapCN.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("thuctapCN.Models.ProjectComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("thuctapCN.Models.TaskComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("thuctapCN.Models.TaskReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("thuctapCN.Models.WorkSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("thuctapCN.Models.TaskComment", b =>
                {
                    b.HasOne("thuctapCN.Models.TaskAssignment", "TaskAssignment")
                        .WithMany()
            ...
            modelBuilder.Entity("thuctapCN.Models.WorkSchedule", b =>
                {
                    b.HasOne("thuctapCN.Models.ApplicationUser", "CreatedByUser")
                        .WithMany()
